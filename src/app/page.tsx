...
const STEPS = [
  { num: '01', icon: '📋', title: 'Paste Your Notes', desc: 'Copy any lecture notes, textbook passages, or study material directly into the AI input.' },
  { num: '02', icon: '🔧', title: 'Choose Your Tool', desc: 'Select from Summariser, Flashcard Generator, or Exam Questions based on what you need to study.' },
  { num: '03', icon: '✨', title: 'Generate Instantly', desc: 'Our Gemini-powered AI analyses your content and generates study material in under 10 seconds.' },
  { num: '04', icon: '🏆', title: 'Study & Ace It', desc: 'Use your personalised AI study content to revise with confidence and walk into your exam prepared.' },
];

const TESTIMONIALS = [
  {
    avatar: '👩‍⚕️', name: 'Emily T.', year: '3rd Year Medicine', uni: 'University of Manchester',
  ...
  {
    avatar: '👨‍💼', name: 'Marcus K.', year: 'MSc Economics', uni: 'London School of Economics',
  ...
  {
    avatar: '👩‍⚖️', name: 'Zara A.', year: '2nd Year Law', uni: 'University of Edinburgh',
...
const MINI_FEATURES = [
  { icon: '🔒', title: 'Zero Data Storage', desc: 'Your notes are never saved on our servers. Everything is processed via the Gemini API in real-time.' },
  { icon: '📱', title: 'Any Device', desc: 'Fully responsive design. Use StudyBoost on your laptop, tablet, or phone — anywhere, any time.' },
  { icon: '🌍', title: 'All Subjects', desc: 'Medicine, Law, Engineering, Economics, History — the AI adapts to any academic subject instantly.' },
  { icon: '🔄', title: 'Spaced Repetition', desc: 'Flashcard structure based on the proven Leitner spaced repetition system for long-term memory.' },
  { icon: '⚡', title: 'Instant Results', desc: 'No waiting. No queuing. AI-generated study content delivered in under 10 seconds every time.' },
  { icon: '💰', title: 'Free to Start', desc: 'Full access to all three AI tools completely free. No credit card. No commitment.' },
];
          ...
          <div className={styles.heroInner}>
            <div className={styles.heroLeft}>
              ...
              <div className={styles.heroCtas} data-reveal data-delay="300">
                <Link href="/ai-tools" className="btn-primary">🚀 Try It Free — No Signup</Link>
                <Link href="/features" className="btn-ghost">See All Features →</Link>
              </div>
              <div className={styles.heroTrust} data-reveal data-delay="400">
                <div className={styles.trustItem}><span className={styles.trustCheck}>✓</span> Free tier available</div>
                <div className={styles.trustItem}><span className={styles.trustCheck}>✓</span> No credit card</div>
                <div className={styles.trustItem}><span className={styles.trustCheck}>✓</span> Your data stays private</div>
              </div>
            </div>
              ...
              <div className={styles.mockupCard}>
                ...
                <div className={styles.mockupBody}>
                  <div className={styles.mockupInput}>
                    <div className={styles.mockupLabel}>📋 Your Notes</div>
                  ...
                  <div className={styles.mockupArrow}>⚡ AI Processing...</div>
                  <div className={styles.mockupOutput}>
                    <div className={styles.mockupLabel} style={{ color: '#34d399' }}>✅ AI Summary</div>
            ...
            <div className={styles.demoLeft} data-reveal="left">
              <div className={styles.demoCard}>
                <div className={styles.demoCardHeader}>
                  <span>📋 Paste your lecture notes</span>
                </div>
                <textarea
                ...
                <button className={`btn-primary ${styles.demoBtn}`} onClick={handleSummarise} disabled={loading}>
                  {loading ? <><span className="spinner" /> Generating...</> : '⚡ Generate AI Summary'}
                </button>
                {!apiKey && (
                  <p className={styles.keyNote}>⚠️ API key not set — <Link href="/contact">contact us</Link> or add key to .env.local</p>
                )}
              </div>
            </div>
      ...
      <section className={styles.statsSection}>
        <div className="container">
          <div className={styles.statsGrid} data-reveal>
            {[
              { val: '50,000+', label: 'Active Students', icon: '🎓' },
              { val: '2M+', label: 'AI Summaries Created', icon: '⚡' },
              { val: '92%', label: 'Pass Rate Improvement', icon: '📈' },
              { val: '4.9 ★', label: 'Average Student Rating', icon: '⭐' },
            ].map((s) => (
      ...
      <section className="section-sm">
        <div className="container">
          <div className={`glass-card ${styles.magnetBox}`} data-reveal>
            ...
            <Link href="/contact" className="btn-primary">📥 Download Free Guide</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className={styles.ctaBox} data-reveal>
            ...
            <div className={styles.ctaBtns}>
              <Link href="/ai-tools" className="btn-primary">🚀 Start Free Now</Link>
